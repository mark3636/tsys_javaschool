...
ALTER TABLE Medical_case
ADD FOREIGN KEY CASE_PATIENT_FK (id_patient) REFERENCES Patient (id) ON DELETE CASCADE;
...
ALTER TABLE Diagnosis
ADD FOREIGN KEY DIAGNOSIS_CASE_FK (id_case) REFERENCES Medical_case (id) ON DELETE CASCADE;
